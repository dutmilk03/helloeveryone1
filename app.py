...
class FaceRecognitionSystem:
    ...
    def switch_page(self):
        ...
        canvas = tk.Canvas(self.new_window, width=1600, height=900, bg="White")
    ...
    def show_webcam(self):
        ...
        imgBg = cv2.imread('pictures/White2.jpg')
        ...
        while True:
          ...
          if not ret:
                ...
                break
          img_resized = cv2.resize(img, (680, 480))
          imgBg[210:210 + 480, 200:200 + 680] = img_resized
